...
class TestRadar(unittest.TestCase):
    ...
    def test_measure_ideal(self):
        ...
        self.assertEqual(
            azimuth, 0.0
        )  # Assuming that the measure method returns None for az if conditions aren't met
    ...
    def test_measure_noisy(self):
        ...
        self.assertEqual(
            range_,
            self.noisy_radar.dist(self.target)
            + self.noisy_radar.rng_noise_std * 1.4965537763705212,
        )
