...
plt.savefig(r"examples\_out\pendulum.png", bbox_inches="tight", pad_inches=0.2, dpi=600)
plt.savefig(r"paper\pendulum.png", bbox_inches="tight", pad_inches=0.2, dpi=600)
plt.show()
